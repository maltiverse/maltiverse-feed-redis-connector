...
parser.add_argument(
    "--redis_database_ipv4",
    dest="redis_database_ipv4",
    default=0,
    help="Specifies Redis database index for IPv4.",
)
parser.add_argument(
    "--redis_database_hostname",
    dest="redis_database_hostname",
    default=1,
    help="Specifies Redis database index for Hostnames.",
)
parser.add_argument(
    "--redis_database_url",
    dest="redis_database_url",
    default=2,
    help="Specifies Redis database index for URL.",
)
parser.add_argument(
    "--redis_database_sample",
    dest="redis_database_sample",
    default=3,
...
for element in json.loads(DATA.text):
    ...
    expiration_date = datetime.utcnow() - timedelta(
        days=arguments.maltiverse_feed_expiration_days
    )
